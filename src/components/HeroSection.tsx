    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* RIGHT SIDE: Before/After Mockups */}
          <motion.div
            className="space-y-6"
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
                    ...
                    <div className="absolute inset-0 bg-white/90 p-3 rounded text-xs">
                      <div className="space-y-1.5">
                        <div className="grid grid-cols-2 gap-1 text-gray-500">
                          <div className="truncate">Company A Inc.</div>
                          <div className="text-red-500">❌ No Email</div>
                        </div>
                        <div className="grid grid-cols-2 gap-1 text-gray-500">
                          <div className="truncate">B Corp LLC</div>
                          <div className="text-red-500">❌ Invalid</div>
                        </div>
                        <div className="grid grid-cols-2 gap-1 text-gray-500">
                          <div className="truncate">Random Co.</div>
                          <div className="text-red-500">❌ Bounce</div>
                        </div>
                        <div className="grid grid-cols-2 gap-1 text-gray-500">
                          <div className="truncate">XYZ Business</div>
                    ...
                    <div className="absolute inset-0 bg-white/95 p-3 rounded text-xs">
                      <div className="space-y-1.5">
                        ...
                        <div className="text-xs text-gray-700 leading-tight">
                          "Hi John, noticed TechCorp's recent Series A..."
                        </div>
                        <Button
                          size="sm"
